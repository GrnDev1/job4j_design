...
class SimpleMapTest {
    ...
    @Test
    void whenCheckPutSimilarIndexAndExpand() {
        assertThat(map.put(0, "0")).isTrue();
        assertThat(map.put(5, "0")).isTrue();
        assertThat(map.put(null, "0")).isFalse();
        assertThat(map.put(8, "0")).isTrue();
        assertThat(map).hasSize(7);
    }

    @Test
    void whenCheckRemoveSimilarIndex() {
        assertThat(map.remove(5)).isFalse();
        assertThat(map.put(0, "0")).isTrue();
    ...
    @Test
    void whenCheckGetSimilarIndex() {
        SimpleMap<Integer, String> map = new SimpleMap<>();
        assertThat(map.put(null, "0000")).isTrue();
        assertThat(map.put(0, "0000")).isFalse();
        assertThat(map.remove(null)).isTrue();
        assertThat(map.get(null)).isNull();
    }

    @Test
    void whenCheckIteratorException() {
        map.remove(3);
        map.put(null, "0000");
        map.remove(null);
        map.put(0, "0000");
